 ...
 * @returns {Uint8Array}
 */
export function delete_js(contents) {
    const ptr0 = passArray8ToWasm0(contents, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.delete_js(ptr0, len0);
    if (ret[3]) {
 ...
 * @returns {string}
 */
export function read_js(contents, password) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray8ToWasm0(contents, wasm.__wbindgen_malloc);
        ...
        const ret = wasm.read_js(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
